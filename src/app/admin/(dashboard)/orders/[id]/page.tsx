	...
	return (
		<div className="space-y-6">
			<div className="flex flex-wrap items-start justify-between gap-4">
				<div>
					<Link
						className="text-[#14163A]/55 text-sm hover:underline"
						href="/admin/orders"
					>
						← Back to orders
					</Link>
					<h1 className="mt-1 font-display font-extrabold text-2xl text-[#14163A]">
						{order.billNumber}
					</h1>
			...
			<div className="grid gap-6 lg:grid-cols-3">
				<div className="rounded-lg border border-[#14163A]/10 bg-white p-5 lg:col-span-1">
					<h2 className="font-bold text-[#14163A]/50 text-sm uppercase tracking-wide">
						Customer
					</h2>
...
function Row({ label, value }: { label: string; value: React.ReactNode }) {
	return (
		<div>
			<dt className="text-[#14163A]/40 text-xs uppercase tracking-wide">
				{label}
			</dt>
