		...
		<header className="sticky top-0 z-40 bg-white shadow-sm">
			...
			<div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-3">
						...
						return (
							<Link
								className={cn(
									...
									isActive
										? "text-[#C8202F]"
										: "text-[#14163A]/70 hover:text-[#14163A]",
								)}
								href={link.href}
								key={link.href}
							>
				...
				<div className="hidden lg:block">
					<Button
						asChild
						className="rounded-full bg-[#14163A] px-6 font-semibold text-white hover:bg-[#1f2257]"
					>
					...
					<SheetContent className="w-72" side="right">
						<nav className="mt-10 flex flex-col gap-1">
							...
							<SheetClose asChild>
								<Button
									asChild
									className="mt-3 rounded-full bg-[#14163A] font-semibold text-white hover:bg-[#1f2257]"
								>
									<Link href="/estimate#price-list">Price list</Link>
								</Button>
							</SheetClose>
