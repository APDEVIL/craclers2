	...
	if (submitMutation.isSuccess) {
		return (
			<div className="flex flex-col items-center gap-3 rounded-lg bg-[#14163A]/5 px-6 py-10 text-center">
				...
				<p className="font-bold text-[#14163A] text-lg">
					Thanks, {name.split(" ")[0]}!
				</p>
	...
	return (
		...
		>
			...
			{submitMutation.error ? (
				<p className="col-span-full font-medium text-[#C8202F] text-sm">
			...
			<div className="col-span-full flex justify-center">
				<Button
					className="rounded-md bg-[#14163A] px-10 font-semibold hover:bg-[#1f2257]"
